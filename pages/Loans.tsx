            ...
            <tbody className="divide-y divide-gray-200 bg-white">
                {filteredLoans.map(loan => {
                    ...
                    <tr key={loan.id} className={`hover:bg-gray-50/50 transition-colors ${isOverdue ? 'bg-red-50' : ''}`}>
                        ...
                        <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{loan.borrowDate}</td>
                        <td className={`whitespace-nowrap px-3 py-4 text-sm ${isOverdue ? 'text-red-600 font-bold' : 'text-gray-500'}`}>{loan.dueDate}</td>
