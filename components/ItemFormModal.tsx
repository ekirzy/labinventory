...
const ItemFormModal = ({ isOpen, onClose, editItem }: Props) => {
  const { addItem, updateItem, labs } = useApp();
          ...
          <form id="item-form" onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <label className="flex flex-col gap-1">
                ...
                <input type="text" value={formData.image} onChange={e => setFormData({ ...formData, image: e.target.value })} className="bg-white border border-gray-300 rounded-lg h-11 px-3 text-gray-900 focus:ring-2 focus:ring-primary/50 focus:border-primary outline-none" placeholder="https://..." />
              </label>
            </div>
